...
! inner x-boundary
  ...
  if(mpid%mpirank_2d(1) .eq.0)then
     ...
     call bd_perx(margin,ro,ix,jx,kx)
     call bd_perx(margin,pr,ix,jx,kx)
     call bd_perx(margin,vx,ix,jx,kx)
     call bd_perx(margin,vy,ix,jx,kx)
     call bd_perx(margin,vz,ix,jx,kx)
     
     call bd_perx(margin,bx,ix,jx,kx)
     call bd_perx(margin,by,ix,jx,kx)
     call bd_perx(margin,bz,ix,jx,kx)
     
     call bd_perx(margin,phi,ix,jx,kx)
     call bd_perx(margin,eta,ix,jx,kx)
