...
!
  ...
  if(mdir .eq. 1)then
     do k=2,kx-1
        do j=2,jx-1
           do i=2,ix-1
            if(ro(i,j,k) < floor2 .or. ro(i-1,j,k) < floor2 .or. ro(i+1,j,k) < floor2) then
...
!
     ...
     do k=2,kx-1
        do j=2,jx-1
           do i=2,ix-1
            if(ro(i,j,k) < floor2 .or. ro(i,j-1,k) < floor2 .or. ro(i,j+1,k) < floor2) then
...
!
     do k=2,kx-1
        do j=2,jx-1
           do i=2,ix-1
            if(ro(i,j,k) < floor2 .or. ro(i,j,k-1) < floor2 .or. ro(i,j,k+1) < floor2) then
