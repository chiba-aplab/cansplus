subroutine MP5toMC2(ix,jx,kx,x,dx,y,dy,z,dz &
  ...
  call switchMP5toMC2(mdir,ix,jx,kx,ro,ro &
       ,row,floor,ratio,xin,x)

  call switchMP5toMC2(mdir,ix,jx,kx,ro,pr &
       ,prw,floor,ratio,xin,x)

  call switchMP5toMC2(mdir,ix,jx,kx,ro,vx &
       ,vxw,floor,ratio,xin,x)

  call switchMP5toMC2(mdir,ix,jx,kx,ro,vy &
       ,vyw,floor,ratio,xin,x)

  call switchMP5toMC2(mdir,ix,jx,kx,ro,vz &
       ,vzw,floor,ratio,xin,x)

  call switchMP5toMC2(mdir,ix,jx,kx,ro,bx &
       ,bxw,floor,ratio,xin,x)

  call switchMP5toMC2(mdir,ix,jx,kx,ro,by &
       ,byw,floor,ratio,xin,x)

  call switchMP5toMC2(mdir,ix,jx,kx,ro,bz &
       ,bzw,floor,ratio,xin,x)

  call switchMP5toMC2(mdir,ix,jx,kx,ro,phi &
