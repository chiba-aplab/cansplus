...
! primitive to conserve
  ...
  !call getEta__anomalous(ix,jx,ro,bx,by,bz,dx,dy,eta0,vc,eta,curx,cury,curz)
...
!
  ...
  call lr_state__MSCL2(mdir,ix,jx,ro,pr,vx,vy,vz,bx,by,bz,phi &
...
!       ,ch,gm,row,prw,vxw,vyw,vzw,bxw,byw,bzw,phiw,ccx,ccy)
  ...
  call flux_calc__fbres(mdir,margin,ix,jx,fbyx,curz,eta,-1.0d0,fbyxr)
  call flux_calc__fbres(mdir,margin,ix,jx,fbzx,cury,eta,+1.0d0,fbzxr)
  call flux_calc__feres(mdir,margin,ix,jx,feex,curx,cury,curz,bx,by,bz,eta,feexr)
!-----Step 1b.---------------------------------------------------------|
...
!
  ...
  call lr_state__MSCL2(mdir,ix,jx,ro,pr,vy,vz,vx,by,bz,bx,phi &
...
!       ,ch,gm,row,prw,vyw,vzw,vxw,byw,bzw,bxw,phiw,ccx,ccy)
  ...
  call flux_calc__fbres(mdir,margin,ix,jx,fbzy,curx,eta,-1.0d0,fbzyr)
  call flux_calc__fbres(mdir,margin,ix,jx,fbxy,curz,eta,+1.0d0,fbxyr)
  call flux_calc__feres(mdir,margin,ix,jx,feey,curx,cury,curz,bx,by,bz,eta,feeyr)
