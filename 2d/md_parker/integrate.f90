...
contains
  ...
  subroutine integrate__TVDRK3(margin,ix,jx,gm,x,dx,y,dy,dt &
...
!  use getEta
  ...
  real(8),dimension(ix,jx),intent(in) :: roi,pri,vxi,vyi,vzi
  real(8),dimension(ix,jx),intent(in) :: bxi,byi,bzi
  real(8),dimension(ix,jx),intent(in) :: phii
  real(8),dimension(ix,jx),intent(in) :: gy
  real(8),dimension(ix,jx),intent(inout) :: ro,pr,vx,vy,vz
  real(8),dimension(ix,jx),intent(inout) :: bx,by,bz,eta
...
!-----Step 2.---------------------------------------------------------|
  ...
  !$OMP PARALLEL DO PRIVATE(i,j,sro,srx,sry,srz,sbz,see,sphi,dtodx,dtody)
