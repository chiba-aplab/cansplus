subroutine integrate_cyl_mp5_2nd_telimit(margin,ix,jx,kx,gm,x,dx,y,dy,z,dz,dt &
     ,gx,gz,floor,ro1,pr1,vx1,vy1,vz1,bx1,by1,bz1,phi1 &
     ,ro,pr,vx,vy,vz,bx,by,bz,phi,ch,cr &
     ,eta0,vc,eta,ccx,ccy,ccz,te_factor,RadCool,time,rohalo,swtch_t,te_limit)
  use convert
  use get_temperature
  implicit none
...
!--Input
  ...
  real(8),intent(in) :: te_factor,RadCool,time,rohalo,swtch_t,te_limit
...
!
  ...
  return
end subroutine integrate_cyl_mp5_2nd_telimit
