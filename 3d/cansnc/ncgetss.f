c======================================================================|
      subroutine ncgetss(idf,name,nd,data_dbl,ndrd)
c======================================================================|
c
c NAME  ncgetss
c
c PURPOSE
c    input scalar sequentially-output double-floating-type variable
c
c OUTPUTS
...
c----------------------------------------------------------------------|      
      ...
      mstatus=nf_get_var1_real(idf,idd,ndrd,data)
