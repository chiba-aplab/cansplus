subroutine integrate_mp5_2nd(margin,ix,jx,kx,gm,x,dx,y,dy,z,dz,dt &
...
!!$
!!$  call lr_state_1D(mdir,ix,jx,kx,ro1 &
!!$       ,row)
!!$  call lr_state_1D(mdir,ix,jx,kx,pr1 &
!!$       ,prw)
!!$
!!$  call lr_state_1D(mdir,ix,jx,kx,vx1 &
!!$       ,vxw)
!!$  call lr_state_1D(mdir,ix,jx,kx,vz1 &
!!$       ,vyw)
!!$  call lr_state_1D(mdir,ix,jx,kx,vz1 &
!!$       ,vzw)
!!$
!!$  call lr_state_1D(mdir,ix,jx,kx,bx1 &
!!$       ,bxw)
!!$  call lr_state_1D(mdir,ix,jx,kx,bz1 &
!!$       ,byw)
!!$  call lr_state_1D(mdir,ix,jx,kx,bz1 &
!!$       ,bzw)
!!$
!!$  call lr_state_1D(mdir,ix,jx,kx,phi1 &
!!$       ,phiw)
...
!
  ...
  return
end subroutine integrate_mp5_2nd
