subroutine integrate_cyl_mp5_2(margin,ix,jx,kx,gm,x,dx,y,dy,z,dz,dt &
...
!
  do k=3,kx-2
     do j=3,jx-2
        do i=3,ix-2
           dtodx = 0.25d0*dt/dx(i)
           ro1(i,j,k) = 3.0d0*ro(i,j,k)/4.0d0 + 0.25d0*ro1(i,j,k) &
                + dtodx*(frox(i-1,j,k)-frox(i,j,k))
           ee1(i,j,k) = 3.0d0*ee(i,j,k)/4.0d0 + 0.25d0*ee1(i,j,k) &
                + dtodx*(feex(i-1,j,k)-feex(i,j,k))
           rx1(i,j,k) = 3.0d0*rx(i,j,k)/4.0d0 + 0.25d0*rx1(i,j,k) &
                + dtodx*(frxx(i-1,j,k)-frxx(i,j,k))
           ry1(i,j,k) = 3.0d0*ry(i,j,k)/4.0d0 + 0.25d0*ry1(i,j,k) &
                + dtodx*(fryx(i-1,j,k)-fryx(i,j,k))
           rz1(i,j,k) = 3.0d0*rz(i,j,k)/4.0d0 + 0.25d0*rz1(i,j,k) &
                + dtodx*(frzx(i-1,j,k)-frzx(i,j,k))
           bx1(i,j,k) = 3.0d0*bx(i,j,k)/4.0d0 + 0.25d0*bx1(i,j,k) &
                + dtodx*(fbxx(i-1,j,k)-fbxx(i,j,k))
           by1(i,j,k) = 3.0d0*by(i,j,k)/4.0d0 + 0.25d0*by1(i,j,k) &
                + dtodx*(fbyx(i-1,j,k)-fbyx(i,j,k))
           bz1(i,j,k) = 3.0d0*bz(i,j,k)/4.0d0 + 0.25d0*bz1(i,j,k) &
                + dtodx*(fbzx(i-1,j,k)-fbzx(i,j,k))
           phi1(i,j,k) = 3.0d0*phi(i,j,k)/4.0d0 + 0.25d0*phi1(i,j,k) &
...
!
  ...
  return
end subroutine integrate_cyl_mp5_2
