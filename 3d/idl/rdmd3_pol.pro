...
if rvs eq 1 then begin
   vx=fltarr(igx,kgx,nx)
   vy=fltarr(igx,kgx,nx)
   vz=fltarr(igx,kgx,nx)
...
if rbs eq 1 then begin
   bx=fltarr(igx,kgx,nx)
   by=fltarr(igx,kgx,nx)
   bz=fltarr(igx,kgx,nx)
   if s3d eq 1 then begin
