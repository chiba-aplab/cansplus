...
! free boundary in x
    if(mpid%l == mnull) then
       ...
       call bd_synpx_car(0,margin,vy,ix,jx,kx)
    ...
    if(mpid%r == mnull) then
       call bd_synpx_car(1,margin,ro,ix,jx,kx)
       call bd_synpx_car(1,margin,pr,ix,jx,kx)
       call bd_synnx_car(1,margin,vx,ix,jx,kx)
       call bd_synpx_car(1,margin,vy,ix,jx,kx)
       call bd_synpx_car(1,margin,vz,ix,jx,kx)
...
! free boundary in y
    if(mpid%b == mnull) then
       call bd_synpy_car(0,margin,ro,ix,jx,kx)
       call bd_synpy_car(0,margin,pr,ix,jx,kx)
       call bd_synpy_car(0,margin,vx,ix,jx,kx)
       call bd_synny_car(0,margin,vy,ix,jx,kx)
       call bd_synpy_car(0,margin,vz,ix,jx,kx)
       call bd_synny_car(0,margin,bx,ix,jx,kx)
       call bd_synpy_car(0,margin,by,ix,jx,kx)
       call bd_synny_car(0,margin,bz,ix,jx,kx)
       call bd_synny_car(0,margin,phi,ix,jx,kx)
       call bd_synpy_car(0,margin,eta,ix,jx,kx)
    end if
    if(mpid%f == mnull) then
       call bd_synpy_car(1,margin,ro,ix,jx,kx)
       call bd_synpy_car(1,margin,pr,ix,jx,kx)
       call bd_synpy_car(1,margin,vx,ix,jx,kx)
       call bd_synny_car(1,margin,vy,ix,jx,kx)
       call bd_synpy_car(1,margin,vz,ix,jx,kx)
       call bd_synpy_car(1,margin,bx,ix,jx,kx)
       call bd_synny_car(1,margin,by,ix,jx,kx)
       call bd_synpy_car(1,margin,bz,ix,jx,kx)
       call bd_synpy_car(1,margin,phi,ix,jx,kx)
       call bd_synpy_car(1,margin,eta,ix,jx,kx)
    end if
