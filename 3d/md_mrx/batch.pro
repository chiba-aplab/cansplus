...
fl1 = field_lines_2d(data2[*,*,0],data2[*,*,1],r0=r0,npos=npos,len=0.5,dir=+1)
fl2 = field_lines_2d(data2[*,*,0],data2[*,*,1],r0=r0,npos=npos,len=0.5,dir=-1)
fl3 = field_lines_2d(data2[*,*,0],data2[*,*,1],r0=r1,npos=npos,len=0.5,dir=-1)
fl4 = field_lines_2d(data2[*,*,0],data2[*,*,1],r0=r2,npos=npos,len=0.5,dir=+1)
