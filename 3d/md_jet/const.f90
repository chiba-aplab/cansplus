module const
  ...
  integer,parameter :: ix = 64+2*margin,jx=16+2*margin,kx=32+2*margin
...
! MPI
  integer,parameter :: mpisize_x = 2, mpisize_z = 4
  integer,parameter :: igx = ix*mpisize_x-2*margin*(mpisize_x-1)
  integer,parameter :: jgx = jx
...
! grid
   ...
   real(8),parameter :: xmax = 10d0, ymax = pi2, zmax = 20d0
