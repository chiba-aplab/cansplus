...
! model parameter
  ...
  !  size 
  real(8),parameter :: xmin = -1.d0
  real(8),parameter :: xmax = -xmin!1.0d0
  real(8),parameter :: ymin = -20.0d0
  real(8),parameter :: ymax = -ymin!10.d0
  real(8),parameter :: zmin = -50.0d0
  real(8),parameter :: zmax = -zmin!60.0d0  
  ...
  ! gravity
  real(8),parameter :: g0 = 1.6d0/gm
  real(8),parameter :: wg0 = 0.5d0

  ! maximum physical value
  real(8),parameter :: ro0=1.0d0
  real(8),parameter :: pr0=1.d0/gm

  ! perturbation
  real(8),parameter ::  amp=0.01d0!0.001d0
  ...
  ! resistivity
  real(8),parameter :: eta0 = 0.0d0!8.30d-2!4.0d0*pi*1.0d-4  ! upper limit of resistivity
