...
! CELL & MPI
  ...
  integer,parameter :: ix = 40+2*margin,jx=100+2*margin,kx=1+2*margin
  ...
  logical,parameter :: pbcheck(3) = (/.true., .false., .false./)
  ! size (uniform grid)
  real(8),parameter :: xmin = -20.d0, ymin = -25.0d0, zmin = -0.5d0 
...
! model parameter
  ...
  real(8),parameter :: vc=1.0d-12      ! threshold 
